...
- oktaActivateFactorByUser
- oktaActivateGroupRulebyID
...
- oktaGetRoleTargetsByUserID
- oktaGetSchemabyID
- oktaGetTypebyID
- oktaGetTypes
- oktaGetUserbyID
- oktaGetUsersbyAppID
- oktaGetUsersbyAppIDWithStatus
- oktaGetUserSchema
- oktaGetUserSchemabyType
- oktaListActiveUsers
- oktaListAppAssignments
- oktaListApps
- oktaListAppsAssignedbyGroupID
...
- oktaSetAppCredentials
- oktaSuspendUserbyID
- oktaUnlockUserbyID
- oktaUnSuspendUserbyID
- oktaUpdateApp
- oktaUpdateAppExternalIdbyUserID
- oktaUpdateAppOverrides
- oktaUpdateAppProfilebyUserID
- oktaUpdateAppScopebyUserID
- oktaUpdateGroupRulebyID
- oktaUpdateUserbyID
- oktaUpdateUserProfilebyID
- oktaUpdateZone
- oktaVerifyMFAnswerbyUser
- oktaVerifyOTPbyUser
- oktaVerifyPushbyUser
